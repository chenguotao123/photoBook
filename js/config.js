...
frmLinkLabel:["lblLink"] //lblLink  frmShareLinkLabel
	...
	productName : 'Demo created by weiyunshang365',
	homePage : 'http://www.weiyunshang365.com/',
	isFlipPdf : "true",
	...
	shareObj = [{"name":"QQ绌洪棿","url":"http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=${url}&title=${title}","logo":"/resourceFiles/share_img/qzone.ico","title":"QQ绌洪棿"},{"name":"鏂版氮寰崥","url":"http://v.t.sina.com.cn/share/share.php?url=${url}&title=${title}","logo":"/resourceFiles/share_img/sina_weibo.ico","title":"鏂版氮寰崥"},{"name":"鑵捐寰崥","url":"http://share.v.t.qq.com/index.php?c=share&a=index&title=${title}&url=${url}","logo":"/resourceFiles/share_img/tencent_weibo.ico","title":"鑵捐寰崥"},{"name":"浜轰汉缃�","url":"http://share.renren.com/share/buttonshare.do?link=${url}&title=${title}","logo":"/resourceFiles/share_img/renren.ico","title":"浜轰汉缃�"}];
	
	bookConfig.loadingCaption="Loading";bookConfig.loadingCaptionColor="#dddddd";bookConfig.loadingPicture="";bookConfig.loadingBackground="#000000";bookConfig.appLogoIcon="./booklogo.png";bookConfig.appLogoLinkURL="http://13726644069";bookConfig.logoHeight="40";bookConfig.logoPadding="0";bookConfig.logoTop="0";bookConfig.HomeURL="%first page%";bookConfig.appLogoOpenWindow="Blank";bookConfig.toolbarColor="#000000";bookConfig.iconColor="#cccccc";bookConfig.pageNumColor="#333333";bookConfig.iconFontColor="#ffffff";bookConfig.FlipSound="No";bookConfig.QRCode="Hide";bookConfig.HomeButtonVisible="Hide";bookConfig.ShareButtonVisible="Hide";bookConfig.socialShareSetting="";bookConfig.ThumbnailsButtonVisible="Show";bookConfig.thumbnailColor="#333333";bookConfig.thumbnailAlpha="5";bookConfig.ZoomButtonVisible="Show";bookConfig.BookMarkButtonVisible="Hide";bookConfig.TableOfContentButtonVisible="Show";bookConfig.bookmarkBackground="#000000";bookConfig.bookmarkFontColor="#cccccc";bookConfig.SearchButtonVisible="Hide";bookConfig.leastSearchChar="5";bookConfig.searchFontColor="#ffffff";bookConfig.PrintButtonVisible="Hide";bookConfig.printWatermarkFile="";bookConfig.BackgroundSoundButtonVisible="Show";bookConfig.BackgroundSoundURL="";bookConfig.BackgroundSoundLoop="-1";bookConfig.AutoPlayButtonVisible="Show";bookConfig.autoPlayAutoStart="No";bookConfig.autoPlayDuration="2.2";bookConfig.autoPlayLoopCount="1";bookConfig.minZoomWidth="403";bookConfig.minZoomHeight="518";bookConfig.mouseWheelFlip="Yes";bookConfig.DownloadButtonVisible="Hide";bookConfig.DownloadURL="";bookConfig.downloadConfig="";bookConfig.InstructionsButtonVisible="Show";bookConfig.bgBeginColor="#000000";bookConfig.bgEndColor="#000000";bookConfig.bgMRotation="90";bookConfig.backGroundImgURL="./backGroundImgURL.jpg";bookConfig.LeftShadowWidth="100";bookConfig.LeftShadowAlpha="1";bookConfig.RightShadowWidth="40";bookConfig.RightShadowAlpha="0.6";bookConfig.HardPageEnable="No";bookConfig.hardCoverBorderWidth="8";bookConfig.borderColor="#572f0d";bookConfig.outerCoverBorder="Yes";bookConfig.cornerRound="8";bookConfig.pageBackgroundColor="#ffffff";bookConfig.flipshortcutbutton="Show";bookConfig.BindingType="side";bookConfig.RightToLeft="No";bookConfig.flippingTime="0.3";bookConfig.retainBookCenter="Yes";bookConfig.FlipStyle="Flip";bookConfig.autoDoublePage="Yes";bookConfig.totalPagesCaption="";bookConfig.pageNumberCaption="";bookConfig.topMargin="5";bookConfig.bottomMargin="10";bookConfig.leftMargin="10";bookConfig.rightMargin="10";bookConfig.leftMarginOnMobile="0";bookConfig.topMarginOnMobile="5";bookConfig.rightMarginOnMobile="0";bookConfig.bottomMarginOnMobile="5";bookConfig.maxWidthToSmallMode="400";bookConfig.maxHeightToSmallMode="400";bookConfig.LinkDownColor="#0000ff";bookConfig.LinkAlpha="0.4";bookConfig.OpenWindow="Blank";bookConfig.showLinkHint="No";bookConfig.googleAnalyticsID="";bookConfig.languageSetting="Chinese";bookConfig.UIBaseURL="";bookConfig.totalPageCount=totalCount;bookConfig.largePageWidth="595";bookConfig.largePageHeight="595";bookConfig.bookTitle="bookTitlebookTitle";bookConfig.normalPath="./files/mobile/";bookConfig.largePath="./files/mobile/";bookConfig.thumbPath="./files/mobile/";bookConfig.productName="weiyunshang365";
